...
public class UISelectItem extends UIFormItem<SelectItemEnhanced>{
	...
	public void setSelectFirstNoBlankOption() {
		item.setSelectFirstNoBlankOption();
	}
	
	public void setSelectFirstOption() {
		item.setSelectFirstOption();
	}

	public int getItemsSize() {
		return item.getItemsSize();
	}
	...
	public HandlerRegistration addDataArrivedHandler(DataArrivedHandler handler) {
		return item.addDataArrivedHandler(handler);
	}
	...
	public void fetchData(DSCallback callback, DSRequest requestProperties) {
		item.fetchData(callback, requestProperties);
	}

	public void fetchData(DSCallback callback) {
		item.fetchData(callback);
	}

	public ListGridRecord[] filterClientPickListData() {
		return item.filterClientPickListData();
	}
	...
	public Boolean getAddUnknownValues() {
		return item.getAddUnknownValues();
	}
	...
	public Boolean getAllowEmptyValue() {
		return item.getAllowEmptyValue();
	}

	public Boolean getAnimatePickList() {
		return item.getAnimatePickList();
	}

	public int getAnimationTime() {
		return item.getAnimationTime();
	}
	...
	public ListGridRecord[] getClientPickListData() {
		return item.getClientPickListData();
	}
	...
	public Boolean getDefaultToFirstOption() {
		return item.getDefaultToFirstOption();
	}
	...
	public int getEmptyPickListHeight() {
		return item.getEmptyPickListHeight();
	}

	public String getEmptyPickListMessage() {
		return item.getEmptyPickListMessage();
	}
	...
	public Boolean getHideEmptyPickList() {
		return item.getHideEmptyPickList();
	}
	...
	public MultipleAppearance getMultipleAppearance() {
		return item.getMultipleAppearance();
	}
	...
	public String getPickerIconStyle() {
		return item.getPickerIconStyle();
	}
	...
	public String getPickListBaseStyle() {
		return item.getPickListBaseStyle();
	}

	public Criteria getPickListCriteria() {
		return item.getPickListCriteria();
	}

	public int getPickListHeaderHeight() {
		return item.getPickListHeaderHeight();
	}

	public int getPickListHeight() {
		return item.getPickListHeight();
	}

	public Integer getPickListWidth() {
		return item.getPickListWidth();
	}
	...
	public Boolean getShowOptionsFromDataSource() {
		return item.getShowOptionsFromDataSource();
	}

	public Boolean getShowOver() {
		return item.getShowOver();
	}
	...
	public String getSortField() {
		return item.getSortField();
	}

	public Integer getSortFieldAsInt() {
		return item.getSortFieldAsInt();
	}
	...
	public void setAddUnknownValues(Boolean addUnknownValues) {
		item.setAddUnknownValues(addUnknownValues);
	}
	...
	public void setAllowEmptyValue(Boolean allowEmptyValue) {
		item.setAllowEmptyValue(allowEmptyValue);
	}

	public void setAnimatePickList(Boolean animatePickList) {
		item.setAnimatePickList(animatePickList);
	}

	public void setAnimationTime(int animationTime) {
		item.setAnimationTime(animationTime);
	}
	...
	public void setAutoFetchData(Boolean autoFetchData) {
		item.setAutoFetchData(autoFetchData);
	}
	...
	public void setControlStyle(String controlStyle) {
		item.setControlStyle(controlStyle);
	}
	...
	public void setDefaultToFirstOption(Boolean defaultToFirstOption) {
		item.setDefaultToFirstOption(defaultToFirstOption);
	}
	...
	public void setEmptyPickListHeight(int emptyPickListHeight) {
		item.setEmptyPickListHeight(emptyPickListHeight);
	}

	public void setEmptyPickListMessage(String emptyPickListMessage) {
		item.setEmptyPickListMessage(emptyPickListMessage);
	}
	...
	public void setHideEmptyPickList(Boolean hideEmptyPickList) {
		item.setHideEmptyPickList(hideEmptyPickList);
	}
	...
	public void setMultipleAppearance(MultipleAppearance multipleAppearance) {
		item.setMultipleAppearance(multipleAppearance);
	}
	...
	public void setPickerIconStyle(String pickerIconStyle) {
		item.setPickerIconStyle(pickerIconStyle);
	}
	...
	public void setPickListBaseStyle(String pickListBaseStyle) {
		item.setPickListBaseStyle(pickListBaseStyle);
	}

	public void setPickListCriteria(Criteria pickListCriteria) {
		item.setPickListCriteria(pickListCriteria);
	}

	public void setPickListCriteria(DSRequest optionFilterContext) {
		item.setPickListCriteria(optionFilterContext);
	}

	public void setPickListFields(ListGridField... pickListFields) {
		item.setPickListFields(pickListFields);
	}

	public void setPickListFilterCriteriaFunction(
			FilterCriteriaFunction filterCriteriaFunction) {
		item.setPickListFilterCriteriaFunction(filterCriteriaFunction);
	}

	public void setPickListHeaderHeight(int pickListHeaderHeight) {
		item.setPickListHeaderHeight(pickListHeaderHeight);
	}

	public void setPickListHeight(int pickListHeight) {
		item.setPickListHeight(pickListHeight);
	}
	...
	public void setPickListWidth(Integer pickListWidth) {
		item.setPickListWidth(pickListWidth);
	}
	...
	public void setSeparatorRows(ListGridRecord[] separatorRows) {
		item.setSeparatorRows(separatorRows);
	}
	...
	public void setShowAllOptions(Boolean showAllOptions) {
		item.setShowAllOptions(showAllOptions);
	}
	...
	public void setShowOptionsFromDataSource(Boolean showOptionsFromDataSource) {
		item.setShowOptionsFromDataSource(showOptionsFromDataSource);
	}

	public void setShowOver(Boolean showOver) {
		item.setShowOver(showOver);
	}
	...
	public void setValueIconField(String valueIconField) {
		item.setValueIconField(valueIconField);
	}
