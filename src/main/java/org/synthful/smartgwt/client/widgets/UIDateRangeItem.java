...
public class UIDateRangeItem extends UIFormItem<DateRangeItem> {

	public UIDateRangeItem() {
	...
	public Boolean getAllowRelativeDates() {
		return item.getAllowRelativeDates();
	}
	...
	public Date getFromDate() {
		return item.getFromDate();
	}

	public String getFromTitle() {
		return item.getFromTitle();
	}
	...
	public void setAllowRelativeDates(Boolean allowRelativeDates) {
		item.setAllowRelativeDates(allowRelativeDates);
	}
