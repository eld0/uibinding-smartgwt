...
public class UICheckboxItem extends UIFormItem<CheckboxItem> {

	public UICheckboxItem() {
		this.item = new CheckboxItem();
	}
	...
	public String getPartialSelectedImage() {
		return item.getPartialSelectedImage();
	}
	...
	public String getUncheckedImage() {
		return item.getUncheckedImage();
	}

	public String getUnsetImage() {
		return item.getUnsetImage();
	}
	...
	public void setCheckedImage(String checkedImage) {
		item.setCheckedImage(checkedImage);
	}
	...
	public void setLabelAsTitle(Boolean labelAsTitle) {
		item.setLabelAsTitle(labelAsTitle);
	}
	...
	public void setPartialSelectedImage(String partialSelectedImage) {
		item.setPartialSelectedImage(partialSelectedImage);
	}
	...
	public void setShowUnsetImage(Boolean showUnsetImage) {
		item.setShowUnsetImage(showUnsetImage);
	}
	...
	public void setUncheckedImage(String uncheckedImage) {
		item.setUncheckedImage(uncheckedImage);
	}

	public void setUnsetImage(String unsetImage) {
		item.setUnsetImage(unsetImage);
	}
